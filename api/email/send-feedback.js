...
<div style="font-family:'Inter',sans-serif;max-width:600px;color:#1a1a2c">
  ...
  <table style="border-collapse:collapse;width:100%;margin-bottom:16px">
    <tr>
      <td style="padding:4px 12px 4px 0;color:#888;font-size:12px;white-space:nowrap">Tipo</td>
      <td style="font-weight:600;font-size:14px">${esc(type)}</td>
    </tr>
  </table>
