...
export const ELEMENT_SCHEMAS = [
  ...
  },
  {
    ...
    ui: { dynamic: true },
    defaults: { dims: { length: 2.4, width: 0.9, height: 0.75 }, color: '#DDD4C8', chairsFront: 3, chairsBack: 3, labelText: '', endHead: true, endFoot: true },
    params: [
      StandardParams.length({ default: 2.4, min: 0.6, max: 12, step: 0.1 }),
      StandardParams.width({ default: 0.9, min: 0.4, max: 6, step: 0.1 }),
      { key: 'chairsFront', path: 'chairsFront', type: 'number', label: 'Sillas frente', default: 3,  min: 0, max: 50, step: 1, level: PARAM_LEVEL.BASIC, category: PARAM_CATEGORY.CHILDREN },
      { key: 'chairsBack',  path: 'chairsBack',  type: 'number', label: 'Sillas fondo',  default: 3,  min: 0, max: 50, step: 1, level: PARAM_LEVEL.BASIC, category: PARAM_CATEGORY.CHILDREN },
      StandardParams.rotation(),
      StandardParams.color({ default: '#DDD4C8' }),
      StandardParams.text({ label: 'Texto mesa' }),
  ...
  },
  {
    ...
    builder: { preset: 'mesaRect' },
    ui: { dynamic: true },
    defaults: { dims: { length: 6.0, width: 1.2, height: 0.75 }, color: '#DDD4C8', chairsFront: 10, chairsBack: 10, labelText: '', endHead: true, endFoot: true },
    params: [
      StandardParams.length({ default: 6.0, min: 1, max: 20, step: 0.1 }),
      StandardParams.width({ default: 1.2, min: 0.5, max: 6, step: 0.1 }),
      { key: 'chairsFront', path: 'chairsFront', type: 'number', label: 'Sillas frente', default: 10, min: 0, max: 50, step: 1, level: PARAM_LEVEL.BASIC, category: PARAM_CATEGORY.CHILDREN },
      { key: 'chairsBack',  path: 'chairsBack',  type: 'number', label: 'Sillas fondo',  default: 10, min: 0, max: 50, step: 1, level: PARAM_LEVEL.BASIC, category: PARAM_CATEGORY.CHILDREN },
      StandardParams.rotation(),
      StandardParams.color({ default: '#DDD4C8' }),
      StandardParams.text({ label: 'Texto mesa' }),
      { key: 'endHead', path: 'endHead', type: 'toggle', label: 'Silla cabecero', default: true, level: PARAM_LEVEL.ADVANCED, category: PARAM_CATEGORY.CHILDREN },
